...
const About = () => {
  return (
    <>
      ...
      <br />
      <h1 className='topic'>For the New Age Skills</h1> <br />
      <p className="subtop">Welcome to Edublends Academy - Pioneering</p> <br />
      <p className="subtop">Your Path to Professional Mastery</p> <br />
<br />
<p className="subtop">At Edublends Academy, we envision education as a bridge to the future :-</p> <br />
...
<br />
<p className="subtop">Our Mission: Empowering Aspirations, Nurturing Talent:- </p><br />
...
<br />
<p className="subtop">Our Vision: Shaping the Future, One Learner at a Time:-</p> <br />
...
<br />
<p className="subtop"> Join Us on Your Journey to Success:-</p> <br />
